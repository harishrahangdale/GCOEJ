...
public class KabaddiScore extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kabaddi_score);

        recyclerView = (RecyclerView) findViewById(R.id.myrecyclerview);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        databaseReference = FirebaseDatabase.getInstance().getReference().child("Kabaddi");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<BlogKabaddi, BlogViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<BlogKabaddi, BlogViewHolder>
                (BlogKabaddi.class, R.layout.blog_row_kabaddi, BlogViewHolder.class, databaseReference) {
            @Override
            protected void populateViewHolder(BlogViewHolder viewHolder, BlogKabaddi model, int position) {
