...
public class Wrkshp extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wrkshp_info);
    ...
    if (!DetectConnection.checkInternetConnection(this)) {
            ...
            web.loadUrl("https://www.gcoej.ac.in/android/view.php?page=Workshop?&spage=Mzg=");
    }
