...
public class BasketScore extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Basket");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<BlogBasket, BlogViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<BlogBasket, BlogViewHolder>
                (BlogBasket.class, R.layout.blog_row_basket, BlogViewHolder.class, databaseReference) {
            @Override
            protected void populateViewHolder(BlogViewHolder viewHolder, BlogBasket model, int position) {
