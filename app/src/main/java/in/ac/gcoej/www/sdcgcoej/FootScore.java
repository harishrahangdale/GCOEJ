...
public class FootScore extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_foot_score);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<BlogFoot, BlogViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<BlogFoot, BlogViewHolder>
                (BlogFoot.class, R.layout.blog_row_foot, BlogViewHolder.class, databaseReference) {
            @Override
            protected void populateViewHolder(BlogViewHolder viewHolder, BlogFoot model, int position) {
