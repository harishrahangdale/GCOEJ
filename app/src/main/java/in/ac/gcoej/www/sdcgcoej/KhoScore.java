...
public class KhoScore extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kho_score);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Kho");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<BlogKho, BlogViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<BlogKho, BlogViewHolder>
                (BlogKho.class, R.layout.blog_row_kho, BlogViewHolder.class, databaseReference) {
            @Override
            protected void populateViewHolder(BlogViewHolder viewHolder, BlogKho model, int position) {
